...
const PALETTE = [
  { cls: 'bg-emerald-600', rgb: '5,150,105' },
  { cls: 'bg-sky-600', rgb: '2,132,199' },
  { cls: 'bg-violet-600', rgb: '124,58,237' },
  { cls: 'bg-amber-500', rgb: '245,158,11' },
  { cls: 'bg-rose-500', rgb: '244,63,94' },
  { cls: 'bg-indigo-600', rgb: '79,70,229' },
  { cls: 'bg-teal-600', rgb: '13,148,136' },
  { cls: 'bg-fuchsia-600', rgb: '192,38,211' }
]
// "General" (the no-subject fallback) reads neutral.
const GENERAL = { cls: 'bg-slate-500', rgb: '100,116,139' }
