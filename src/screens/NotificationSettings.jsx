  ...
  return (
    <AppShell><div className="px-5 py-8">
      <div className="max-w-sm mx-auto">
        ...
        <h1 className="text-[20px] font-bold text-[var(--ink)] tracking-tight mt-2 mb-6">Notifications</h1>

        <motion.div
          initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.25, ease: [0.23, 1, 0.32, 1] }}
          className="bg-[var(--card)] rounded-3xl p-5 border border-[var(--border)] shadow-sm mb-3"
        >
          <div className="flex justify-between items-center mb-2">
            <p className="text-[14px] font-bold text-[var(--ink)]">Daily due reminder</p>
            <input
              type="checkbox"
          ...
          <p className="text-[12px] text-[var(--muted)] mb-3">One reminder listing what's due today</p>
          <input
            type="time"
            ...
            className="border border-[var(--border)] rounded-xl px-3 py-2 text-[13px] text-[var(--ink)] bg-[var(--card-alt)] disabled:opacity-40"
          />
        </motion.div>
        ...
        >
          <div className="flex justify-between items-center mb-2">
            <p className="text-[14px] font-bold text-[var(--ink)]">Streak-at-risk nudge</p>
            <input
              type="checkbox"
          ...
          <p className="text-[12px] text-[var(--muted)] mb-3">Only fires if you haven't revised yet and have an active streak</p>
          <input
            type="time"
        ...
        {saving && <p className="text-[11px] text-[var(--muted)] mt-3">Saving...</p>}
      </div>
    </div></AppShell>
  )
}
