        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'hook' && (
            <Screen id="hook" onBack={goBack} muted={T.muted} footer={<Btn onClick={() => setStep('curve')}>Continue</Btn>}>
              ...
              <h1 style={{ color: T.ink, transition: colorTransition, animationDelay: '0.12s' }} className="animate-enter text-[23px] font-bold tracking-tight leading-snug mb-2">You don't have a studying problem. You have a forgetting problem.</h1>
              <p style={{ color: T.muted, transition: colorTransition, animationDelay: '0.2s' }} className="animate-enter text-[14.5px]">Psychologists proved the average student loses most of what they learn within just 24 hours.</p>
            </Screen>
          )}
